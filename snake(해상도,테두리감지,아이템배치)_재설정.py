...
# blank_img = np.zeros((768, 1024, 3), np.uint8)
...
while True:
    ...
    print('while문 속 Width: ' + str(video.get(3)))
    print('while문 속 Height: ' + str(video.get(4)))
    ...
    cv2.rectangle(frame, (155, 5), (1120, 715), (255, 0, 0), 10)
    ...
    cv2.putText(frame, str('play time : ' + str(play_time)), (950, 50), font, 0.6, (0, 0, 0), 1, cv2.LINE_AA)
